...
import { Star, ShieldCheck, ArrowRight, Sparkles, Check, Mail } from "lucide-react";
...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        className="absolute inset-0 -z-10 bg-grid opacity-60 [mask-image:linear-gradient(to_bottom,black,transparent_75%)]"
        aria-hidden
      />
        ...
        <div className="flex flex-col items-start gap-6">
          ...
          <Reveal delay={120}>
            <p className="max-w-xl text-lg text-muted-foreground text-balance">
              ...
              français irréprochable, en 10 minutes.{" "}
              <strong className="text-foreground">Sans abonnement piège.</strong>
            </p>
          </Reveal>
          ...
          <Reveal delay={240}>
            <div className="flex flex-col gap-2 text-sm text-muted-foreground sm:flex-row sm:items-center sm:gap-5">
              ...
              <span>+{formatFr(SITE.applicationsSent)} candidatures</span>
              <span className="hidden sm:inline" aria-hidden>
                ·
              </span>
              <span className="inline-flex items-center gap-1.5">
    ...
    <div className="relative">
      ...
      <div className="rounded-2xl border border-border bg-card shadow-xl">
        ...
        <div className="flex items-center gap-2 border-t border-border px-5 py-3 text-xs text-muted-foreground">
          ...
          Mail de candidature généré et prêt à envoyer
        </div>
      </div>
    </div>
  );
